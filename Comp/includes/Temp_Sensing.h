...
//Signals
#define TEMP_SENSING_SIGNAL_REQUESTED           (1<<0)
#define TEMP_SENSING_SIGNAL_RELEASED            (1<<1)
#define TEMP_SENSING_SIGNAL_START               (1<<2)
#define TEMP_SENSING_SIGNAL_STOP                (1<<3)
#define TEMP_SENSING_SIGNAL_UPDATE_TEMPERATURE  (1<<4)
