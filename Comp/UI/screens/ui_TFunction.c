...
void ui_TFunction_screen_init(void)
{
    ui_TFunction = lv_obj_create(NULL);
    lv_obj_remove_flag(ui_TFunction, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_bg_image_src(ui_TFunction, &ui_img_bk_dark_png, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Chart1 = lv_chart_create(ui_TFunction);
    ...
    ui_ValTemp4 = lv_label_create(ui_TFunction);
    lv_obj_set_width(ui_ValTemp4, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_ValTemp4, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_ValTemp4, 6);
    lv_obj_set_y(ui_ValTemp4, -79);
    lv_obj_set_align(ui_ValTemp4, LV_ALIGN_CENTER);
    lv_label_set_text(ui_ValTemp4, "25 °C");
    lv_obj_set_style_text_color(ui_ValTemp4, lv_color_hex(0x29CE20), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_ValTemp4, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_ValTemp4, &lv_font_montserrat_36, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui_ValTemp4, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_ValTemp4, lv_color_hex(0x3AB634), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_ValTemp4, 100, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_color(ui_ValTemp4, lv_color_hex(0x179130), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_opa(ui_ValTemp4, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui_ValTemp4, 75, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_spread(ui_ValTemp4, 1, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Label10 = lv_label_create(ui_TFunction);
    ...
    ui_BHome3 = lv_button_create(ui_TFunction);
    lv_obj_set_width(ui_BHome3, 42);
    lv_obj_set_height(ui_BHome3, 43);
    lv_obj_set_x(ui_BHome3, 86);
    lv_obj_set_y(ui_BHome3, -134);
    lv_obj_set_align(ui_BHome3, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_BHome3, LV_OBJ_FLAG_SCROLL_ON_FOCUS);     /// Flags
    lv_obj_remove_flag(ui_BHome3, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_radius(ui_BHome3, 44, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_BHome3, lv_color_hex(0x253A24), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_BHome3, 190, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_src(ui_BHome3, &ui_img_home3_png, LV_PART_MAIN | LV_STATE_DEFAULT);

    lv_obj_add_event_cb(ui_BHome3, ui_event_BHome3, LV_EVENT_ALL, NULL);
    uic_TFunction = ui_TFunction;
    uic_BHome3 = ui_BHome3;

}

void ui_TFunction_screen_destroy(void)
{
    if(ui_TFunction) lv_obj_del(ui_TFunction);
